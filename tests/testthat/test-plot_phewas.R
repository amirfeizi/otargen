test_that("test plot_phewas works", {
  expected_1 <- otargen::pheWAS(variantid = "14_87978408_G_A") %>% otargen::plot_phewas(disease = TRUE)
  expected_2 <- otargen::pheWAS(variantid = "rs55808324") %>% otargen::plot_phewas()
