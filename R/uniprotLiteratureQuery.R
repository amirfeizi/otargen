...
#'
#' This function queries the Open Targets Genetics GraphQL API to retrieve UniProt literature evidence data
...
#' @examples
#' \dontrun{
#' result <- uniprotLiteratureQuery(ensemblId = "ENSG00000130203", efoId = "MONDO_0004975", size = 3500)
#' }
#' @importFrom magrittr %>%
