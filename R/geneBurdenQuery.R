...
#'
#' This function queries the Open Targets Genetics GraphQL API to retrieve gene burden evidence data
...
#' @examples
#' \dontrun{
#' result <- geneBurdenQuery(ensemblId = "ENSG00000137642", efoId = "MONDO_0004975", size = 3500)
#' }
#' @importFrom magrittr %>%
