...
#' @param \emph{studyids} List of Strings: List of Open Targets Genetics generated IDs for GWAS studies.
#'
...
#' @examples
#' \dontrun{
#' result <- overlapInfoForStudy(studyid = "GCST90002357", studyids = list("GCST90025975", "GCST90025962"))
#' }
#' @import dplyr
#' @importFrom magrittr %>%
#' @export
