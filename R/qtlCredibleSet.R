...
#'
#' In Open Targets, the lead variants are expanded into a more comprehensive set of candidate causal variants referred to as the tag variants.
...
#' @examples
#' \dontrun{
#' result <- qtlCredibleSet(study_id = "Braineac2", variant_id = 
#' "1_55053079_C_T",
