...
#'
#' This function queries the Open Targets Genetics GraphQL API to retrieve shared trait studies data
...
#' @examples
#' \dontrun{
#' result <- sharedTraitStudiesQuery(diseaseIds = c("EFO_0004587"), size = 500, index = 0)
#' }
#' @importFrom magrittr %>%
