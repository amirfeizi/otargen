...
#'
#' This function queries the Open Targets Genetics GraphQL API to retrieve QTL credible sets data
...
#' @examples
#' \dontrun{
#' result <- qtlCredibleSetsQuery(variantId = "19_10352442_G_C", size = 500, index = 0)
#' }
#' @importFrom magrittr %>%
